...
C {lvnot.sym} 1170 -180 0 0 {name=x325[15:0] m=1 
+ wn=20u lln=2.4u wp=40u lp=2.4u
+ VCCPIN=vcc VSSPIN=vss}
C {lvnot.sym} 1250 -180 0 0 {name=x8[15:0] m=1 
+ wn=30u lln=2.4u wp=60u lp=2.4u
+ VCCPIN=vcc VSSPIN=vss}
C {lvnor2.sym} 1070 -180 0 0 {name=x9[15:0] m=1 
+ wna=10u lna=2.4u wpa=40u lpa=2.4u
+ wnb=10u lnb=2.4u wpb=40u lpb=2.4u
+ VCCPIN=vcc VSSPIN=vss VSSBPIN=VSS}
C {lab_pin.sym} 1290 -180 0 1 {name=p59 lab=LDZ[15:0]}
C {lab_pin.sym} 1030 -200 0 0 {name=p61 lab=LDY[3:0]*4}
C {lab_pin.sym} 1030 -160 0 0 {name=p62 lab=4*LDX[3:0]}
C {lab_pin.sym} 40 -250 0 1 {name=p18 lab=vss}
C {capa.sym} 40 -300 0 0 {name=c1[3:0] m=1 value=35f}
C {lab_pin.sym} 40 -330 0 1 {name=p4 lab=LDX[3:0]}
C {lab_pin.sym} 220 -250 0 1 {name=p6 lab=vss}
C {capa.sym} 220 -300 0 0 {name=c2[3:0] m=1 value=16f}
...
C {lvnot.sym} 1170 -300 0 0 {name=x18[15:0] m=1 
+ wn=20u lln=2.4u wp=40u lp=2.4u
+ VCCPIN=vcc VSSPIN=vss}
C {lvnot.sym} 1250 -300 0 0 {name=x19[15:0] m=1 
+ wn=30u lln=2.4u wp=60u lp=2.4u
+ VCCPIN=vcc VSSPIN=vss}
C {lvnot.sym} 1250 -410 0 0 {name=x21[15:0] m=1 
+ wn=30u lln=2.4u wp=60u lp=2.4u
+ VCCPIN=vcc VSSPIN=vss}
C {lvnot.sym} 1250 -530 0 0 {name=x22[15:0] m=1 
+ wn=30u lln=2.4u wp=60u lp=2.4u
+ VCCPIN=vcc VSSPIN=vss}
C {lab_pin.sym} 1130 -300 0 0 {name=p26 lab=LDZI[15:0]}
